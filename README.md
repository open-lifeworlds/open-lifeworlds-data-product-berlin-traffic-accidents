[![Issues](https://img.shields.io/github/issues/open-lifeworlds/open-lifeworlds-data-product-berlin-traffic-accidents)](https://github.com/open-lifeworlds/open-lifeworlds-data-product-berlin-traffic-accidents/issues)

<br />
<p align="center">
  <a href="https://github.com/open-lifeworlds/open-lifeworlds-data-product-berlin-traffic-accidents">
    <img src="logo-with-text.png" alt="Logo" style="height: 80px; ">
  </a>

  <h1 align="center">Berlin Traffic Accidents</h1>

  <p align="center">
    Data product combining Berlin traffic accident data and geodata
  </p>
</p>
...
See
the [open issues](https://github.com/open-lifeworlds/open-lifeworlds-data-product-berlin-traffic-accident/issues)
